...
typedef SWIFT_ENUM(NSInteger, Fit) {
  FitWidth = 0,
  FitHeight = 1,
  FitWidthFlexible = 2,
  FitHeightFlexible = 3,
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, HorizontalAlign) {
...
typedef SWIFT_ENUM(NSInteger, LayoutDirection) {
...
typedef SWIFT_ENUM(NSInteger, PinSafeAreaInsetsDidChangeMode) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, VerticalAlign) {
